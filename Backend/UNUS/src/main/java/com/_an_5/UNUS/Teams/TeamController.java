...
public class TeamController {
    ...
    public String incrementGamesStat(@PathVariable int id, @RequestBody HashMap<String, String> map) {
        User user = userRepository.findById(id);
        if (user == null) {
            return failure;
        }
        boolean win = Boolean.parseBoolean(map.get("win"));
        if (win) {
