...
public class ZDeleteUserTest {
    ...
    public void deleteUserTest() {
        ...
        ViewInteraction materialButton3 = onView(
                allOf(withId(R.id.delete_user), withText("Delete Account"),
                        childAtPosition(
                                childAtPosition(
                                        withId(R.id.fragmentContainerView),
                                        0),
        ...
        ViewInteraction appCompatEditText3 = onView(
                allOf(withId(R.id.user_prompt),
                        childAtPosition(
                                ...
                                1),
                        isDisplayed()));
        appCompatEditText3.perform(replaceText("newuser"), closeSoftKeyboard());
        ...
        ViewInteraction textView = onView(
                allOf(withId(R.id.login_header), withText("Enter Login Credentials"),
                        withParent(withParent(withId(R.id.fragmentContainerView))),
                        isDisplayed()));
        textView.check(matches(withText("Enter Login Credentials")));
    }
