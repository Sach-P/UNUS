...
public class FriendRequestTest {
    ...
    public void friendRequestTest() {
        ...
        ViewInteraction button = onView(
                allOf(withText("Requests"),
                        childAtPosition(
                                allOf(withId(R.id.friend_buttons),
                                        childAtPosition(
                                                withId(R.id.friends),
                                                2)),
                                2),
        ...
        ViewInteraction textView = onView(
                allOf(withId(R.id.friend_reqs), withText("Friend Requests (0): "),
                        withParent(withParent(IsInstanceOf.<View>instanceOf(android.widget.LinearLayout.class))),
                        isDisplayed()));
        textView.check(matches(withText("Friend Requests (0): ")));
    }
