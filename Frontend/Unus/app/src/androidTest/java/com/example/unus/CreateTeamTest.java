...
public class CreateTeamTest {
    ...
    public void createTeamTest() {
        ...
        ViewInteraction appCompatEditText3 = onView(
                allOf(withId(R.id.name_prompt),
                        childAtPosition(
                                ...
                                1),
                        isDisplayed()));
        appCompatEditText3.perform(replaceText("testteamqwerasdf"), closeSoftKeyboard());

        ViewInteraction materialButton4 = onView(
                allOf(withId(R.id.create), withText("Create Team"),
                        childAtPosition(
                                childAtPosition(
                                        withClassName(is("android.widget.LinearLayout")),
                                        0),
        ...
        ViewInteraction textView = onView(
                allOf(withText("testteamqwerasdf"),
                        withParent(withParent(withId(R.id.results))),
                        isDisplayed()));
        textView.check(matches(withText("testteamqwerasdf")));
        ...
        ViewInteraction materialButton5 = onView(
                allOf(withId(R.id.join), withText("Delete Team"),
                        childAtPosition(
                                childAtPosition(
                                        withClassName(is("android.widget.LinearLayout")),
                                        0),
